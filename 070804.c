...
void control_scoreboard(int st,int end,int r[],int h[],int e[], int b[]); //스코어 보드 제어 함수 정의 
void display_scoreboard(int r[], int h[], int e[], int b[]); //스코어 보드 표시 함수 정의 
void draw_check02(int c, int r); //그리기 함수 정의 
...
void draw_check02(int c, int r) //그리기 함수 생성 
{
    int i, j;
...
void display_scoreboard(int r[], int h[], int e[], int b[]) //스코어 보드 표시 함수 생성 
{
	int i, j;
	printf("스코어보드 \n");
	draw_check02(17, 3);
...
void control_scoreboard(int st,int end, int r[], int h[], int e[], int b[]) //스코어 보드 제어 함수 생성 
{
